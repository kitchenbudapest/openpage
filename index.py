...
{0.o}+---------------------------------------------------------{7.o}----{7.c}-----------------+{0.c}
{0.o}|{0.c}                                                         {7.o}\   \{7.c}                {0.o}|{0.c}
{0.o}|{0.c}                                                          {7.o}\ F \{7.c}               {0.o}|{0.c}
{0.o}|{0.c}                                                           {7.o}\ O \{7.c}              {0.o}|{0.c}
{0.o}|{0.c}                                                            {7.o}\ R \{7.c}             {0.o}|{0.c}
{0.o}|{0.c}                                                             {7.o}\ K \{7.c}            {0.o}|{0.c}
{0.o}+--------------------------------------------+-----------------{0.c}{7.o}\   \{7.c}{0.o}-----------+{0.c}
{0.o}|{0.c}                                            {0.o}|{0.c} {1.o}#######{1.c}          {7.o}\ U \{7.c}          {0.o}|{0.c}
{0.o}|{0.c} Come In,                                   {0.o}|{0.c} {1.o}#{1.c}     {1.o}#{1.c} Kitchen   {7.o}\ S \{7.c}         {0.o}|{0.c}
{0.o}|{0.c} We Are Open!                               {0.o}|{0.c} {1.o}#{1.c}     {1.o}#{1.c} Budapest   {7.o}\   \{7.c}        {0.o}|{0.c}
{0.o}|{0.c}                                            {0.o}|{0.c} {1.o}#{1.c}     {1.o}#{1.c} Powered by T{7.o}\ O \{7.c}       {0.o}|{0.c}
{0.o}|{0.c}                                            {0.o}|{0.c} {1.o}#######{1.c}              {7.o}\ N \{7.c}      {0.o}|{0.c}
{0.o}+--------------------------------------------+-----------------------{0.c}{7.o}\   \{7.c}{0.o}-----+{0.c}
{0.o}|{0.c}                                                                     {7.o}\ G \{7.c}    {0.o}|{0.c}
{0.o}|{0.c} {2.o}news{2.c}                                                                 {7.o}\ I \{7.c}   {0.o}|{0.c}
{0.o}|{0.c} {{                                                                     {7.o}\ T \{7.c}  {0.o}|{0.c}
{0.o}|{0.c}     {3.o}.next_hackathon{3.c} {4.o}={4.c} {{{6.o}7{6.c}, {6.o}8{6.c}, {5.o}"August"{5.c}}};                                {7.o}\ H \{7.c} {0.o}|{0.c}
{0.o}|{0.c} }}                                                                       {7.o}\ U \{7.c}{0.o}|{0.c}
{0.o}|{0.c}                                                                          {7.o}\ B |{7.c}
{0.o}|{0.c} {2.o}links{2.c}                                                                     {7.o}\  |{7.c}
{0.o}|{0.c} {{                                                                          {7.o}\ |{7.c}
{0.o}|{0.c}     {3.o}.github{3.c}    {4.o}={4.c} {5.o}"https://github.com/kitchenbudapest"{5.c};                      {7.o}\|{7.c}
{0.o}|{0.c}     {3.o}.more_info{3.c} {4.o}={4.c} {5.o}"http://www.kibu.hu"{5.c};                                       {0.o}|{0.c}
{0.o}|{0.c} }}                                                                            {0.o}|{0.c}
{0.o}|{0.c}                                                                              {0.o}|{0.c}
{0.o}+------------------------------------------------------------------------------+{0.c}
{0.o}|{0.c}                                                                              {0.o}|{0.c}
{0.o}|{0.c}                         {0.o}(c) 2015 Kitchen Budapest{0.c}                            {0.o}|{0.c}
{0.o}|{0.c}                                                                              {0.o}|{0.c}
{0.o}+------------------------------------------------------------------------------+{0.c}\
"""
